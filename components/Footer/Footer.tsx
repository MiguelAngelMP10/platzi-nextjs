  ...
  >
    <Container text>
      <Grid stackable>
        ...
        <Grid.Row>
          <Grid.Column width={7}>
            <Header as="h4">Modificado en </Header>
            <p>
              <a href="https://platzi.com/">Platzi y con el curso de Next.JS</a>{' '}
              de Platzi por el alumno por{' '}
              <a href="https://twitter.com/MiguelAngelMP10">@MiguelAngelMP10</a>
            </p>
            <List horizontal style={{ display: 'flex' }}>
              <List.Item
                ...
                style={{ display: 'flex' }}
                content={
                  <a href="https://twitter.com/MiguelAngelMP10">Twitter</a>
                }
              />
              <List.Item
                icon="github"
                style={{ display: 'flex' }}
                content={
                  <a href="https://github.com/MiguelAngelMP10/platzi-nextjs">
                    GitHub
                  </a>
                }
              />
